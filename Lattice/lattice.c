...
int main() {
    ...
    // Read the number of particles and the dimensions of the box
    ...
    particles[currentParticle].synapses = 1; //Set the first particle with 1 synapse
    ...
    for (int i = 0; i < N_connections; ++i) {
        ...
        for (int attempt = 0; attempt < numParticles; ++attempt) {
            ...
            if (candidateParticle != currentParticle) {
                ...
                if (((double)rand() / RAND_MAX) < prob && synapse < N_synapses) {
