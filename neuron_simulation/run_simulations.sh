...
run_random_simulation() {
    ...
    ARG3="positions/neurons_dat_5k_200Lx_random"              # Positions data 
    ...
    OUTPUT_DIR2="5k_random_200Lx_0,5rad_0,09817pac_10e5time_1branch_2synapses"
...
run_lattice_simulation() {
    ...
    ARG1=200    # Box size
    ARG2=100000 #Time steps
    ARG3="positions/neurons_dat_5k_200Lx_lattice"             # Positions data 
    BASE_FILENAME_CONNECTIONS="connections_dat"     # Connections fine name
    BASE_FILENAME_RESULTS="results_dat"             # Multi branch results file name
    OUTPUT_DIR1="simulations"
    OUTPUT_DIR2="5k_lattice_200Lx_0,5rad_0,09817pac_10e5time_1branch_2synapses"
...
run_hexagonal_simulation() {
    ...
    ARG1=200    # Box Size
    ARG2=100000 # Time Steps
    ARG3="positions/neurons_dat_5k_200Lx_hexagonal"   # Positions data 
    BASE_FILENAME_CONNECTIONS="connections_dat"     # Connections fine name
    BASE_FILENAME_RESULTS="results_dat"             # Multi branch results file name
    OUTPUT_DIR1="simulations"
    OUTPUT_DIR2="5k_hexagonal_200Lx_0,5rad_0,09817pac_10e5time_1branch_2synapses"
...
run_cluster_simulation() {
    ...
    ARG1=200    # Box Size
    ARG2=100000 # Time Steps
    ARG3="positions/neurons_dat_5k_200Lx_cluster"   # Positions data 
    BASE_FILENAME_CONNECTIONS="connections_dat"     # Connections fine name
    BASE_FILENAME_RESULTS="results_dat"             # Multi branch results file name
    OUTPUT_DIR1="simulations"
    OUTPUT_DIR2="5k_cluster_200Lx_0,5rad_0,09817pac_10e5time_1branch_2synapses"
