...
set style line 5 lc rgb "gold" lw 2               #Gold connections
...
do for [i=1:150] {
    ...
    plot 'neurons_dat' using 1:2:3 with circles lc rgb "blue" fill solid 0.2 notitle, \
         for [j=0:3] 'connections_dat' index j using 1:2:3 every ::1::i with circles lc rgb word(colors, j+1) fill solid 0.5 notitle, \
         for [j=0:3] 'connections_dat' index j every ::1::i with lines ls (j+2) notitle, \
