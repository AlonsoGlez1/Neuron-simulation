...
file_directory = os.path.join("simulations", "5k_lattice_150Lx_0,5rad_0,17453pac_10e5time_1branch_2synapses") # Relative path
...
output_directory = "simulations/lattice_150_statistics"
